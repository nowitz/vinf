...
public class DrawingWindow extends JPanel{
	...
	public DrawingWindow()
	{
		...
		// Kliknutí na region se zjistí zda je možné obkreslit kraj, pokud ne je zvyrazená Praha
		this.addMouseListener(new MouseListener() {
			public void mouseReleased(MouseEvent e) {
				...
				String select = map.isInArea(pointer);
				...
				if(!selectRegion.equals(select))
					...
					System.out.println("DrawingWindow: "+selectRegion);
						selectRegion = select;
						repaint();
						//TODO modální okno s informace o kraji
					}
			}
	...
	public void drawLegenda(Graphics2D g2)
	{
		...
		TextLayout labelLayout = new TextLayout("% - Nezaměstnanost v roce "+currentYear+" bla bla bla.", fontNadpis, g2.getFontRenderContext());
	...
	/**
	 * Method for set the following year and while it is running animations and turns off at the last frame
	 */
	...
	void addActions() {		
		...
		// Move timer setting timer start in 3s and later repeated with a period of 1250 ms
